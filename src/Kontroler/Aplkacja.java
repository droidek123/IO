...
public class Aplkacja {
    ...
    private static int maxKlientId;
    ...
    public static void dodajFilmDoListy() {
        Scanner scanner = new Scanner(System.in);
        int rokWydania, czasTrwania;
    ...
    public static void zaktualizujFilm(){
        Scanner scanner = new Scanner(System.in);
    ...
    public static void dodajKlientaMenu(){
        Scanner scanner = new Scanner(System.in);
        int wiek, telefon;
        ...
        try {
            ...
            maxKlientId++;
            dodajKlienta(maxKlientId, imie, nazwisko, wiek, adres, telefon);
        } catch (NumberFormatException e) {
            System.out.println("Podano zly format danych");
        }
    }

    public static void zaktualizujDaneKlientaMenu(){
        Scanner scanner = new Scanner(System.in);
        int id, wiek, telefon;
        String imie, nazwisko, adres;
        wyswietlKlientow();
    ...
    public static void wypozyczFilmKlientowiMenu(){
        Scanner scanner = new Scanner(System.in);
        int id;
    ...
    public static void zarezerwujFilmKlientowiMenu(){
        Scanner scanner = new Scanner(System.in);
        int id;
    ...
    public static void zwrocFilmZWypMenu(){
        Scanner scanner = new Scanner(System.in);
        int id;
    ...
    public static void zwolnijFilmZRez(){
        Scanner scanner = new Scanner(System.in);
        int id;
    ...
    public static void klientMenu() {
        ...
        do {
            ...
            switch (wyborOperacji) {
                ...
                case 4: {
                    zaktualizujDaneKlientaMenu();
                    break;
                }
                case 5: {
                    wypozyczFilmKlientowiMenu();
                    break;
                }
                case 6: {
                    zarezerwujFilmKlientowiMenu();
                    break;
                }
                case 7: {
                    zwrocFilmZWypMenu();
    ...
    public static void main(String[] args) {
        ...
        boolean quit = false;
        maxKlientId = listaKlientow.size();
